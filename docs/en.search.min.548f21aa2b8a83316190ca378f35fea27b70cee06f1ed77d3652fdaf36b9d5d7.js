...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.67e978c4f4396c54c9d16936daff75c6b11f74cc87d07af4c386975d7055840e.js',function(){input.required=false;search();});}
