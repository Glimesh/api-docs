...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.5f47fc5a0b947581774cc669e43b65308850747572729051ae54ea68db08e7f7.js',function(){input.required=false;search();});}
