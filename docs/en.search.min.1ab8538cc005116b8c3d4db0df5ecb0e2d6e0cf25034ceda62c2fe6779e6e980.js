...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.1e1d9e45efaddfc717459f65343ff733a3252cdd09f795b54db6152cf03ced67.js',function(){input.required=false;search();});}
