...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.038817485b282e2402b7d7e8142c39228fa1a3d4e7020b6ae28c67424ab47a53.js',function(){input.required=false;search();});}
