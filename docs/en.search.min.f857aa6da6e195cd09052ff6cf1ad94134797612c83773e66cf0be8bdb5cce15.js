...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6e2981336d62ec2aeb68bf3a7888729d79809b97570ccdb2da7668d7306afbd3.js',function(){input.required=false;search();});}
