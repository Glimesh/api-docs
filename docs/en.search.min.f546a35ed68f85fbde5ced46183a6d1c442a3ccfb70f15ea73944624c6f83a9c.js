...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.5d5f30cd9c54a009335abe7f0cd7f71b5dfcb5248ad1fc2a557b4be1039b65fe.js',function(){input.required=false;search();});}
