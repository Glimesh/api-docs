...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.8c8f0f9653e90c2196756765d65e7aee8ee7e3fbe6f47194cdcebfa88d80bc53.js',function(){input.required=false;search();});}
