...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.f7ee56f212ed1a7285a450689342ce00aacefaf4ffe2f7bbde4c26d8884b9032.js',function(){input.required=false;search();});}
