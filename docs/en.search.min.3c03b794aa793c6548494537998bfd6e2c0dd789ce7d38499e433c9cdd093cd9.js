...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/api-docs/flexsearch.min.js');loadScript('/api-docs/en.search-data.min.fe12802a013102ff654983c5fdc556a014ba91e183185ed62af16373d6a9b0e5.js',function(){input.required=false;search();});}
